...
/**
 * Initializes a new instance of the AutoSuggestClientImpl class.
 */
public class AutoSuggestClientImpl extends AzureServiceClient implements AutoSuggestClient {
     ...
     */
    public AutoSuggestClientImpl withAcceptLanguage(String acceptLanguage) {
     ...
     * @return the service client itself
     */
    public AutoSuggestClientImpl withLongRunningOperationRetryTimeout(int longRunningOperationRetryTimeout) {
     ...
     * @return the service client itself
     */
    public AutoSuggestClientImpl withGenerateClientRequestId(boolean generateClientRequestId) {
     ...
     */
    public AutoSuggestClientImpl(ServiceClientCredentials credentials) {
     ...
     * @param credentials the management credentials for Azure
     */
    public AutoSuggestClientImpl(String baseUrl, ServiceClientCredentials credentials) {
    ...
    private void initializeService() {
        service = restClient().retrofit().create(AutoSuggestClientService.class);
    }

    /**
     * The interface defining all the services for AutoSuggestClient to be
     ...
     */
    public Suggestions autoSuggest(String query) {
     ...
     */
    public ServiceFuture<Suggestions> autoSuggestAsync(String query, final ServiceCallback<Suggestions> serviceCallback) {
     ...
     * @return the observable to the Suggestions object
     */
    public Observable<ServiceResponse<Suggestions>> autoSuggestWithServiceResponseAsync(String query) {
        if (query == null) {
     ...
     * @return the Suggestions object if successful.
     */
    public Suggestions autoSuggest(String query, String acceptLanguage, String pragma, String userAgent, String clientId, String clientIp, String location, String countryCode, String market, SafeSearch safeSearch, String setLang, List<ResponseFormat> responseFormat) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Suggestions> autoSuggestAsync(String query, String acceptLanguage, String pragma, String userAgent, String clientId, String clientIp, String location, String countryCode, String market, SafeSearch safeSearch, String setLang, List<ResponseFormat> responseFormat, final ServiceCallback<Suggestions> serviceCallback) {
        return ServiceFuture.fromResponse(autoSuggestWithServiceResponseAsync(query, acceptLanguage, pragma, userAgent, clientId, clientIp, location, countryCode, market, safeSearch, setLang, responseFormat), serviceCallback);
    }
